...
\begin{itemize}[noitemsep,nolistsep]
  \item Self-study for learning recursion, black-box abstraction, and gaps between CS and math.
\end{itemize}
...
\begin{itemize}[noitemsep,nolistsep]
  ...
  \item Use Nginx, \textsc{go} http servers, and SQLite3/BoltDB.

  \item Made go package and git submodule for blog database with SQLite3.
\end{itemize}
