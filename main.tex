...
\hangindent=\parindent % adds indent to second line
Building sites with \textbf{\textsc{html}}, \textbf{\textsc{css}},
  \textbf{JavaScript}, \& \textbf{\textsc{go}};
Data analysis with \textbf{Excel}, \textbf{\textsc{r}}, \& \textbf{Python};
Building schemas and querying with \textbf{\textsc{sql}};
\textbf{Bash} scripting and server administration with \textbf{Linux};
Presenting data with \textbf{R Markdown}, \textbf{PowerPoint}, and \textbf{\LaTeX{}};
Version control and continuous integration with \textbf{git} and \textbf{Docker}.
...
%
% \subsection{Programs:} \:
% Excel · Access · RStudio · git ·  Linux · \textsc{MATLAB} · Basic Docker · CI/CD
...
% todo figure out what's up with vspace here
