...
{Actuarial education site with math notes written in markdown and converted to \textsc{html} and pdf.
Strong integration with git and email for contributions.}
%%%%%%%%%%%  P&C Climate Change Prez   %%%%%%%%%%%
\project{\textit{The Claim Before the Storm}}{https://www.angelcastaneda.org/claim-before.pdf}{slide deck, poll}
...
\vspace{-5mm} % TODO investigate bottom minipage margins
